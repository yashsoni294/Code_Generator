...
base_path = input("Please Enter the base or folder path of your existing Code Base: ")


# Add 'Generated_script' folder to the base path
base_path = os.path.join(base_path, "Generated_script")

# Create the 'Generated_script' folder if it does not exist
if not os.path.exists(base_path):
    os.makedirs(base_path)
    print(f"The folder {base_path} was created.")
...
print(f"User story and acceptance criteria submitted.")
...
if frame_work == 1:
    print(f"You selected FastAPI framework.")
else:
    print(f"You selected Django framework.")
...
try:
    with open(full_path, "w", encoding='utf-8') as file:
        file.write(gen_code)
    print(f"Generated code is successfully written to: {full_path}")
except PermissionError:
    print("Permission denied: You need elevated privileges to write to the root folder.")
except Exception as e:
    print(f"An error occurred: {e}")
